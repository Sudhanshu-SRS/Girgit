    ...
    <div className="healthcare-page">
      <div className="container">
        <div className="page-header">
          ...
          <p>
            Exploring how generative AI is transforming healthcare through
          ...
          <div className="analytics-section">
            ...
            <div className="analytics-grid">
              <div className="analytics-card">
                <h3>{analytics.totalEntries || 0}</h3>
              ...
              <div className="analytics-card">
                <h3>
                  {analytics.statusCounts?.find((s) => s._id === "deployed")
                    ?.count || 0}
                </h3>
              ...
              {healthcareData.map((item) => (
                <div key={item._id} className="application-card">
                  <div className="card-header">
                    <h3>{item.title}</h3>
                    <span
                      className={`status-badge ${item.implementationStatus}`}
                    >
                    ...
                    {item.caseStudy && (
                      <div className="case-study">
                        ...
                        <p>
                          ...
                          {item.caseStudy.hospitalName}
                        </p>
                        <p>
                          <strong>Location:</strong> {item.caseStudy.location}
                        </p>
                        {item.caseStudy?.patientsImpacted && (
                          <p>
                            <strong>Patients Impacted:</strong>{" "}
                            {item.caseStudy.patientsImpacted.toLocaleString()}
                          </p>
                        )}
                      </div>
                    )}
        ...
        <div className="sample-section">
          ...
          <div className="sample-grid">
            <div className="sample-card">
              ...
              <p>
                Deep learning models that can detect early-stage cancer with 95%
                accuracy, helping radiologists make faster and more precise
                diagnoses.
              </p>
            ...
            <div className="sample-card">
              ...
              <p>
                AI algorithms that identify potential drug compounds and predict
                their effectiveness, reducing drug development time from years
                to months.
              </p>
              <div className="sample-stats">
            ...
            <div className="sample-card">
              ...
              <p>
                AI systems that analyze patient data to create customized
                treatment protocols, improving patient outcomes and reducing
                side effects.
              </p>
              <div className="sample-stats">
